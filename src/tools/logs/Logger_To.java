...
class Logger_To{
     ...
     */
    public Logger_To(String file, boolean useDateFileName) {
        setFile( file );
     ...
     */
    public Logger_To(String file, boolean useDateFileName, boolean deleteFile) {
        setFile( file );
        this.useDateFileName(useDateFileName);
        if( deleteFile ){
            this.delete();
    ...
    protected synchronized void println(String msg) {
        ...
        try {
            ...
            String line = mDateFormat.format(new Date()) + " - " + msg;
    ...
    /**
     * It return teh file without format
     * @return It is the name of the file
     */
